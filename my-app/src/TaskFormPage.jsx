...
// --- Main Page Component ---
export default function TaskFormPage({ theme, toggleTheme }) {
    ...
    const crumbs = [
        ...
        { label: project ? project.name : 'Project', path: `/projects/${projectId}` },
        { label: 'New Task', path: null }
    ];
            ...
            <div className="flex flex-col flex-1 overflow-hidden">
                 <Header>
                    <div className="flex items-center space-x-2">
                        <button onClick={() => navigate(`/projects/${projectId}`)} className="bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 px-4 py-2 rounded-lg text-sm font-semibold hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors">
                            Discard
                        </button>
                        <button onClick={() => { alert('Save functionality not implemented.'); navigate(`/projects/${projectId}`); }} className="bg-indigo-600 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-indigo-700 transition-colors">
                            Save
                        </button>
                    </div>
                </Header>
                    ...
                    <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md max-w-4xl mx-auto">
                        <form className="space-y-6">
                            ...
                            <div>
                                ...
                                <select id="assignee" className="mt-1 block w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                            ...
                            <div>
                                ...
                                <input type="text" id="project" value={project?.name || ''} readOnly className="mt-1 block w-full px-3 py-2 bg-gray-100 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm" />
                            </div>
                            <div>
                                <label htmlFor="tags" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Tags</label>
                                <input type="text" id="tags" className="mt-1 block w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" placeholder="e.g., UI, Bug, Feature" />
                            </div>
                            <div>
