                    ...
                    <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md max-w-4xl mx-auto">
                        <form className="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="tags" className="mt-1 block w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" placeholder="e.g., Marketing, Q4, Redesign" />
                            </div>

                            {/* Project Manager */}
                            <div>
                                <label htmlFor="project-manager" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Project Manager</label>
                                <select id="project-manager" className="mt-1 block w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                    {Object.entries(mockProjectManagers).map(([id, user]) => (
                            ...
                            <div>
                                ...
                                <div className="mt-2 flex items-center space-x-6">
                                    <label className="flex items-center"><input type="radio" name="priority" value="low" className="form-radio h-4 w-4 text-indigo-600" /> <span className="ml-2">Low</span></label>
                                    <label className="flex items-center"><input type="radio" name="priority" value="medium" defaultChecked className="form-radio h-4 w-4 text-indigo-600" /> <span className="ml-2">Medium</span></label>
                                    <label className="flex items-center"><input type="radio" name="priority" value="high" className="form-radio h-4 w-4 text-indigo-600" /> <span className="ml-2">High</span></label>
                                </div>
                            </div>
